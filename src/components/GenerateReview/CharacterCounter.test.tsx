...
describe("CharacterCounter Component", () => {
  ...
  describe("error state", () => {
    it("should show destructive color when showError is true", () => {
      const { container } = render(<CharacterCounter current={50} max={200} showError={true} />);
    ...
    it("should show destructive color even below threshold when showError is true", () => {
      const { container } = render(<CharacterCounter current={10} max={200} showError={true} />);
  ...
  describe("accessibility", () => {
    ...
    it("should include screen reader label when provided", () => {
      render(<CharacterCounter current={50} max={200} label="Front text character count" />);
