  ...
  if (success) {
    return (
      <div className="w-full max-w-md space-y-6">
        <div
          className={cn("rounded-md border border-green-500/50 bg-green-500/10 p-4", "dark:bg-green-500/20")}
          role="alert"
          aria-live="assertive"
        >
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 space-y-2">
              <p className="text-sm font-medium text-green-600 dark:text-green-400">Password reset email sent</p>
              <p className="text-sm text-muted-foreground">
                Check your inbox at <strong>{email}</strong> for instructions to reset your password. If you don&apos;t
        ...
        <div className="text-center">
          <a href="/auth/sign-in" className="text-sm text-primary hover:underline">
            Back to sign in
          </a>
        </div>
      </div>
  ...
  return (
    <div className="w-full max-w-md space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Button type="submit" disabled={!emailValid || loading} className="w-full">
